...
namespace MyVet.Prism.ViewModels
{
    public class ProfilePageViewModel : ViewModelBase
    {
        ...
        private async Task<bool> ValidateData()
        {
            ...
            {
                await App.Current.MainPage.DisplayAlert("Error", "Ingrese un Documento", "Accept");
                return false;
            }
            ...
            {
                await App.Current.MainPage.DisplayAlert("Error", "Ingrese Apellido", "Accept");
                return false;
            }

            if (string.IsNullOrEmpty(Owner.Address))
            {
                await App.Current.MainPage.DisplayAlert("Error", "Ingrese Domicilio", "Accept");
                return false;
            }
