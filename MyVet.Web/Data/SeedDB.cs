...
namespace MyVet.Web.Data
{
    public class SeedDb
    {
        ...
        public async Task SeedAsync()
        {
            ...
            await CheckRoles();
            var manager = await CheckUserAsync("1010", "Luis", "Nuñez", "luisalbertonu@gmail.com", "156814963", "Espora 2052", "Admin");
            var customer = await CheckUserAsync("2020", "Luis", "Nuñez", "luis.albiazul@hotmail.com", "156814963", "Espora 2052", "Customer");
